  ...
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center relative overflow-hidden px-4">
      ...
      <div className="z-10 text-center space-y-8 max-w-2xl animate-fade-in">
        <div className="inline-flex items-center space-x-2 px-4 py-2 bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 rounded-full text-sm font-medium mb-4">
        ...
        <h1 className="text-5xl md:text-7xl font-bold tracking-tight text-white mb-6">
          Expense <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-400 to-emerald-600">Tracker</span>
        </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12 text-left">
           {[
             ...
             <div key={i} className="flex items-center space-x-3 text-slate-300 bg-slate-900/40 p-3 rounded-2xl border border-white/5">
        ...
        <button
          ...
          className="group relative flex items-center justify-center space-x-3 w-full max-w-sm mx-auto py-4 bg-white hover:bg-slate-100 text-slate-950 text-lg font-bold rounded-2xl transition-all shadow-2xl hover:scale-[1.02] active:scale-95 overflow-hidden"
        >
        ...
        <p className="text-xs text-slate-600 uppercase tracking-widest font-bold mt-8">
